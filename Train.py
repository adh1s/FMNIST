...
#name for locally saving model and training stats
directory = 'trained_model'
#if FMNIST is locally stored in file named 'dataset', set to False
download = True 
...
train_set = torchvision.datasets.FashionMNIST('dataset', train=True, transform=transform_train, download=download)
...
scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=step_size, gamma=gamma, last_epoch=- 1, verbose=False)
...
#counts the number of epochs without a validation accuracy improvement for early stopping
counter = 0 
